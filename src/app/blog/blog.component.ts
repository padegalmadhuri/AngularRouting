...
export class BlogComponent implements OnInit {
    data=[{
      name:"Magna nostrud incididunt cupidatat cillum incididunt et nisi in ut minim reprehenderit.",
      ...
      name:"Dolore pariatur amet ullamco aliquip mollit aliqua qui.",
      ...
      name:"Velit esse dolor dolor qui cillum velit in quis exercitation occaecat.",
